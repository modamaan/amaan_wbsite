      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="flex justify-center">
          <div className="relative w-full max-w-lg aspect-square border-[4px] border-black rounded-full overflow-hidden bg-[#FF6B6B] shadow-[-8px_8px_0px_0px_rgba(0,0,0,1)]">
            <Image src="/images/amaan_1.png" alt="About me illustration" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="space-y-6 md:space-y-8">
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              I am Mohammed Amaan, a Software Developer with 3+ years of experience building websites, web apps, and SaaS products.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm md:text-base">
                  Delivering high-quality code and scalable architectures across various domains, focusing on modern web technologies.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">20+ successful projects</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Consistently meeting client and business needs by building robust SaaS platforms, interactive web applications, and stunning websites.
                </p>
              </div>
            </div>
          </div>
          ...
          <Button asChild className="bg-[#0B0B0B] text-white hover:bg-black/90 rounded-lg py-5 px-8 md:py-[22px] md:px-[62px] text-base md:text-lg font-semibold h-auto w-full sm:w-auto sm:min-w-[240px]">
            <Link href="https://linkedin.com/in/mohamedamaan319" target="_blank" rel="noopener noreferrer">
