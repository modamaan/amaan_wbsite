...
export function PortfolioSection() {
  const projects = [
    {
      ...
      description:
        "Develop an AI-powered platform that conducts mock interviews with real-time feedback, question generation, and performance analysis",
    ...
    },
    {
      title: "DemoFlow",
      description:
        "saas product demo presentation creation platform",
      tag: "UI/UX Design",
      github: "https://github.com/modamaan/demoflow_landingpage",
      liveLink: "",
      bgColor: "bg-[#2F81F7]",
  ...
  return (
    <section id="works" className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Take a look at my <br />
            <span className="bg-[#FFC224] text-black px-3 py-1 inline-block">Works</span>
          </h2>
        </div>
        ...
        <div className="flex justify-center">
          <a
            href="https://github.com/modamaan"
            target="_blank"
            rel="noopener noreferrer"
