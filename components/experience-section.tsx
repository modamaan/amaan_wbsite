  ...
  const experiences = [
    {
      ...
      title: "Freelance",
      description:
        "Fiverr • Part-time. Building production-ready web applications.",
      icon: "/images/fiverr_com_logo.jpg",
    },
    {
      period: "Sep 2025 - Nov 2025",
      title: "Full Stack Engineer Intern",
      description:
        "The Smart Language • Internship • Remote. Developed and maintained web applications.",
      icon: "/images/smart_language.jpg",
    },
    {
      period: "Nov 2024 - Jul 2025",
      title: "Junior Full Stack Engineer",
      description:
        "Open Healthcare Network • Internship. Contributed to transformative healthcare solutions impacting 362k+ lives across 11 states. Developed user-friendly interfaces using TypeScript, React, and Tailwind CSS.",
      icon: "/images/ohc.jpg",
    },
  ]
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          <div className="text-white pt-0 md:pt-12 md:sticky md:top-12 self-start">
            ...
            <Button asChild className="bg-white text-black hover:bg-gray-50 rounded-lg py-5 px-8 md:py-[22px] md:px-[62px] text-base md:text-lg font-semibold h-auto w-full sm:w-auto sm:min-w-[240px]">
              <a href="/images/ResumeAmaan_new.pdf.pdf" target="_blank" rel="noopener noreferrer">
