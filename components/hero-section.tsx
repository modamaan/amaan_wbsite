    ...
    <section id="home" className="container mx-auto px-4 py-16 md:py-24">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[clamp(28px,5vw,72px)] font-bold leading-[1.25]">
            I'm <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-block whitespace-nowrap">Mohammed Amaan</span> a Software Engineer from{" "}
            <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block whitespace-nowrap">Kerala, India</span>
          </h1>

          <p className="text-[#393939] text-[16px] md:text-[18px] font-medium leading-[28px] md:leading-[30px] max-w-xl">
            I design & develop user interfaces for web and mobile applications.
